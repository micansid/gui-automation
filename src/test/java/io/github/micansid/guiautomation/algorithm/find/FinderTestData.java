...
import io.github.micansid.guiautomation.util.image.ImageLoader;
...
public enum FinderTestData implements Supplier<Image> {
  ...
  BUTTON_FRAME("intellij_button_frame.png", new Position(599, 787),
      new Position(683, 787)),
  CHECKBOX_UNCHECKED("intellij_checkbox_unchecked.png", new Position(474, 106),
      new Position(474, 129), new Position(474, 152), new Position(472, 224),
      new Position(472, 248), new Position(472, 272), new Position(472, 344),
      new Position(472, 368), new Position(472, 392), new Position(472, 416),
      new Position(472, 440)),
  CHECKBOX_CHECKED("intellij_checkbox_checked.png", new Position(472, 296),
      new Position(472, 320), new Position(472, 567));
